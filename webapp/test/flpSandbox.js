		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title Barcode",
									"targetURL": "#comnttesrabarutzpp002serino-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comnttesrabarutzpp002serino-display": {
								"semanticObject": "comnttesrabarutzpp002serino",
								"action": "display",
								"description": "A Fiori Barcode application.",
								"title": "App Title Barcode",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ntt.esrabarut.zpp002serino",
									"url": sap.ui.require.toUrl("com/ntt/esrabarut/zpp002serino")
								}
							}
						}
					}
